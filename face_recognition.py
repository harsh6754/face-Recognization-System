...
#                     cv2.putText(
#                         img, "Unknown Face", (x, y-55), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255, 255, 255), 3)
#                 coord = [x, y, w, h]
    ...
    def face_recog(self):
        def draw_boundary(img, classifier, scaleFactor, minNeighbors, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                if confidence > 77:
                    cv2.putText(img, f"Student_id: {i}", (x, y-75),
                                cv2.FONT_HERSHEY_COMPLEX, 0.8, color, 3)
                    cv2.putText(
                        img, f"Roll: {r}", (x, y-55), cv2.FONT_HERSHEY_COMPLEX, 0.8, color, 3)
                    cv2.putText(
                        img, f"Name: {n}", (x, y-30), cv2.FONT_HERSHEY_COMPLEX, 0.8, color, 3)
                    cv2.putText(
                        img, f"Department: {d}", (x, y-5), cv2.FONT_HERSHEY_COMPLEX, 0.8, color, 3)
